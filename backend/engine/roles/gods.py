...
register_role(
    RoleSpec(
        ...
        display_zh="女巫",
        display_en="Witch",
        description_zh="拥有一瓶解药和一瓶毒药，整局各一次且同夜只能使用一瓶；仅首夜可自救。",
...
register_role(
    RoleSpec(
        ...
        display_zh="守卫",
        display_en="Guard",
        description_zh="每晚可守护一名其他玩家，不能自守或连续两晚守同一人。",
        description_en="Protects another player; cannot self-guard or repeat the same target on consecutive nights.",
        night_action="guard",
