...
STRINGS: dict[str, str] = {
    ...
    "tip.lookahead_depth": "前瞻深度(按决策点计)；留空/负数=全深度（默认）。深度过浅会在到达终局前返回未决区间。",
    ...
    "help.lookahead_depth": "前瞻深度（决策点计；留空/负数=全深度，默认全深度）",
...
EN_STRINGS: dict[str, str] = {
    ...
    "tip.lookahead_depth": "Lookahead depth in decision points; empty/negative = full depth (default).",
